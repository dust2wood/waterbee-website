...
Ion-coated electrodes maintain measurement stability for over 6 months, with accurate measurement in pH 6–8 range without pH compensation.`,
    ...
    specs: [
      { label: '측정 방식', labelEn: 'Measurement Method', value: 'Polarograph Amperometric 회전전극식 (무시약식)' },
      { label: '측정 형태', labelEn: 'Measurement Type', value: 'pH 미보상 (pH 6.5~7.5)' },
      { label: '측정 범위', labelEn: 'Measurement Range', value: '0 ~ 2 mg/L (잔류염소), 수온(℃)' },
      { label: '분해능', labelEn: 'Resolution', value: '0.01 mg/L, 0.1℃' },
      { label: '정확도', labelEn: 'Accuracy', value: '±2% or ±0.03 mg/L' },
      { label: '응답 시간', labelEn: 'Response Time', value: '90%, 2분 이내' },
      { label: '샘플 유량', labelEn: 'Sample Flow Rate', value: '200 ~ 700 mL/min' },
      { label: '전원', labelEn: 'Power Supply', value: 'AC 110~240V ±10%, 50/60Hz, DC 12V' },
      { label: '통신', labelEn: 'Communication', value: 'RS-232, RS-485, Modbus RTU/TCP, 이더넷(옵션)' },
      { label: '아날로그 출력', labelEn: 'Analog Output', value: '4~20mA 2CH' },
      { label: '릴레이', labelEn: 'Relay', value: '자동세정, 경보, 릴레이 (3CH)' },
      { label: '컨트롤러', labelEn: 'Controller', value: 'WBSC10 스마트 컨트롤러 (4.3" TFT LCD)' },
      { label: '재질', labelEn: 'Material', value: '외함 Acetal/Aluminum, 측정 수조 Acrylic, 전극 Gold/Silver' },
      { label: '크기 (컨트롤러)', labelEn: 'Dimensions (Controller)', value: '210 × 180 × 86.5 mm' },
      { label: '사용환경', labelEn: 'Operating Environment', value: '수중 -5~50℃, 대기 -20~60℃, 최대압력 65 Psig' },
    ],
...
The auto-cleaning function prevents optical contamination errors for long-term stable operation.`,
    ...
    specs: [
      { label: '측정 방식', labelEn: 'Measurement Method', value: '90° 산란광 (EPA 180.1)' },
      { label: '광원', labelEn: 'Light Source', value: 'Tungsten Lamp (580nm)' },
      { label: '측정 범위', labelEn: 'Measurement Range', value: '0 ~ 10 NTU' },
      { label: '분해능', labelEn: 'Resolution', value: '0.001 NTU' },
      { label: '정확도', labelEn: 'Accuracy', value: '±2% or ±0.01 NTU' },
      { label: '응답 시간', labelEn: 'Response Time', value: '90%, 10분 이내' },
      { label: '샘플 유량', labelEn: 'Sample Flow Rate', value: '50 ~ 300 mL/min' },
      { label: '전원', labelEn: 'Power Supply', value: 'AC 110~240V ±10%, 50/60Hz, DC 12V' },
      { label: '통신', labelEn: 'Communication', value: 'RS-232, RS-485, Modbus RTU/TCP, 이더넷(옵션)' },
      { label: '아날로그 출력', labelEn: 'Analog Output', value: '4~20mA 2CH' },
      { label: '릴레이', labelEn: 'Relay', value: '자동세정, 경보, 릴레이 (3CH)' },
      { label: '컨트롤러', labelEn: 'Controller', value: 'WBSC10 스마트 컨트롤러 (4.3" TFT LCD)' },
      { label: '재질', labelEn: 'Material', value: '측정부 ABS/Acetal, 램프부 Aluminium' },
      { label: '구조', labelEn: 'Structure', value: '기포제거 유동 구조 (탈부착 가능)' },
      { label: '사용환경', labelEn: 'Operating Environment', value: '수중 -5~50℃, 대기 -20~60℃, 최대압력 65 Psig (50℃)' },
    ],
...
An intuitive display and easy calibration make field operation convenient.`,
    ...
    specs: [
      { label: 'pH 측정 방식', labelEn: 'pH Method', value: '유리 전극식 (WBPH10)' },
      { label: 'pH 측정 범위', labelEn: 'pH Range', value: '0 ~ 14 pH' },
      { label: 'pH 분해능/정확도', labelEn: 'pH Resolution/Accuracy', value: '0.01 pH / ±0.1 pH' },
      { label: 'EC 측정 방식', labelEn: 'EC Method', value: '교류 2전극식 (WBEC10)' },
      { label: 'EC 측정 범위', labelEn: 'EC Range', value: '0 ~ 2,000 μS/cm' },
      { label: 'EC 분해능/정확도', labelEn: 'EC Resolution/Accuracy', value: '0.1 μS/cm / 1.5%FS, ±0.3℃' },
      { label: '출력', labelEn: 'Output', value: '4~20mA, RS-485' },
      { label: 'pH 보호 등급/재질', labelEn: 'pH Protection/Material', value: 'IP68, PPS' },
      { label: 'EC 보호 등급/재질', labelEn: 'EC Protection/Material', value: 'IP68, Stainless steel' },
      { label: '컨트롤러', labelEn: 'Controller', value: 'WBSC10 스마트 컨트롤러 (4.3" TFT LCD)' },
      { label: '전원', labelEn: 'Power Supply', value: 'AC 110~240V ±10%, 50/60Hz, DC 12V, 7W' },
      { label: '통신', labelEn: 'Communication', value: 'RS-232, RS-485, Modbus RTU/TCP, TCP/IP' },
      { label: '아날로그 출력', labelEn: 'Analog Output', value: '4~20mA 2CH' },
      { label: '릴레이', labelEn: 'Relay', value: '자동세정, 경보, 릴레이 (3CH)' },
      { label: '크기 (컨트롤러)', labelEn: 'Dimensions (Controller)', value: '210 × 180 × 86.5 mm' },
    ],
