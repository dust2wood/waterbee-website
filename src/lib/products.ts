...
Ion-coated electrodes maintain measurement stability for over 6 months, with accurate measurement in pH 6–8 range without pH compensation.`,
    ...
    specs: [
      ...
      { label: '정확도', labelEn: 'Accuracy', value: '±2% or ±0.03 mg/L', valueEn: '±2% or ±0.03 mg/L' },
...
An intuitive display and easy calibration make field operation convenient.`,
    ...
    specs: [
      { label: 'pH 측정 방식', labelEn: 'pH Method', value: '유리 전극식 (WBPH10)', valueEn: 'Glass electrode (WBPH10)' },
      { label: 'pH 측정 범위', labelEn: 'pH Range', value: '0 ~ 14 pH', valueEn: '0 ~ 14 pH' },
      { label: 'pH 분해능/정확도', labelEn: 'pH Resolution/Accuracy', value: '0.01 pH / ±0.1 pH', valueEn: '0.01 pH / ±0.1 pH' },
      { label: 'EC 측정 방식', labelEn: 'EC Method', value: '교류 2전극식 (WBEC10)', valueEn: 'AC 2-electrode (WBEC10)' },
      { label: 'EC 측정 범위', labelEn: 'EC Range', value: '0 ~ 2,000 μS/cm', valueEn: '0 ~ 2,000 μS/cm' },
      { label: 'EC 분해능/정확도', labelEn: 'EC Resolution/Accuracy', value: '0.1 μS/cm / 1.5%FS, ±0.3℃', valueEn: '0.1 μS/cm / 1.5%FS, ±0.3℃' },
      { label: '출력', labelEn: 'Output', value: '4~20mA, RS-485', valueEn: '4~20mA, RS-485' },
      { label: 'pH 보호 등급/재질', labelEn: 'pH Protection/Material', value: 'IP68, PPS', valueEn: 'IP68, PPS' },
      { label: 'EC 보호 등급/재질', labelEn: 'EC Protection/Material', value: 'IP68, Stainless steel', valueEn: 'IP68, Stainless steel' },
      { label: '컨트롤러', labelEn: 'Controller', value: 'WBSC10 스마트 컨트롤러 (4.3" TFT LCD)', valueEn: 'WBSC10 smart controller (4.3" TFT LCD)' },
      { label: '전원', labelEn: 'Power Supply', value: 'AC 110~240V ±10%, 50/60Hz, DC 12V, 7W', valueEn: 'AC 110~240V ±10%, 50/60Hz, DC 12V, 7W' },
      { label: '통신', labelEn: 'Communication', value: 'RS-232, RS-485, Modbus RTU/TCP, TCP/IP', valueEn: 'RS-232, RS-485, Modbus RTU/TCP, TCP/IP' },
      { label: '아날로그 출력', labelEn: 'Analog Output', value: '4~20mA 2CH', valueEn: '4~20mA 2CH' },
      { label: '릴레이', labelEn: 'Relay', value: '자동세정, 경보, 릴레이 (3CH)', valueEn: 'Auto-cleaning, alarm, relay (3CH)' },
      { label: '크기 (컨트롤러)', labelEn: 'Dimensions (Controller)', value: '210 × 180 × 86.5 mm', valueEn: '210 × 180 × 86.5 mm' },
    ],
...
Made of SUS 304 stainless steel for excellent corrosion resistance and durability.`,
  ...
  },
  {
    ...
    application: ['water_treatment', 'wastewater', 'industrial'],
    featured: false,
    shortDescription: 'AI·IoT 기반 여과·배수·수질측정 통합 제어 — 무단수 운영, 전·후단 탁도 동시 분석',
    shortDescriptionEn: 'AI·IoT-based integrated filter, drain & water quality control — no-shutdown operation, pre/post turbidity analysis',
    description: `스마트 여과드레인 시스템은 워터비의 수질계측 기술을 기반으로, 여과·배수·수질측정을 하나의 모듈에서 통합 제어하도록 설계된 시스템입니다.
실시간으로 여과 효율을 모니터링하고, 탁도·잔류염소 데이터를 이용해 필터 상태와 교체 시점을 예측하며, 모듈별 독립 작동으로 단수 없이 유지보수가 가능한 무단수 운영 구조를 갖춥니다.
자동 드레인 기능과 여과 시스템을 통합한 모듈형·직선형 설계로, 전·후단 탁도를 동시에 측정하여 필터 오염 및 상태를 정밀 진단하고, AI 기반 자동제어에 최적화된 데이터를 제공합니다. 성과공유제(공공기관 협력) 사업을 통해 개발되었으며, HSCMT와 기술 고도화 MOU를 체결해 공동 개선을 추진하고 있습니다.`,
    descriptionEn: `The Smart Filter Drain System is designed to integrate filtration, drainage, and water quality measurement in a single module, based on Waterbee's water quality measurement technology.
It monitors filtration efficiency in real time, uses turbidity and residual chlorine data to predict filter condition and replacement timing, and features a no-shutdown maintenance structure with independent module operation.
The modular, linear design combines automatic drain and filtration in one system. Simultaneous pre- and post-filter turbidity measurement enables precise diagnosis of filter fouling and condition, providing data optimized for AI-based automatic control. Developed through the performance-sharing (public institution collaboration) program, with an MOU signed with HSCMT for joint technology advancement.`,
    features: [
