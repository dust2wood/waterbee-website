...
Compared to conventional manual operation, it minimizes operating personnel and enables remote monitoring and control through a cloud server.`,
    ...
    specs: [
      ...
      { label: '연동 센서', labelEn: 'Linked Sensors', value: '탁도계, 잔류염소계 (워터비 제품)', valueEn: 'Turbidity, residual chlorine (Waterbee)' },
      ...
      { label: '설치 방식', labelEn: 'Installation', value: '벽걸이형 / 패널 내장형', valueEn: 'Wall-mount / panel-mount' },
    ],
