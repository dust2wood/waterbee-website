...
Its transparent acrylic body allows visual inspection and can be configured to match site piping and instrumentation.`,
  ...
  },
  {
    ...
    application: ['water_treatment'],
    featured: false,
    shortDescription: 'WBCL10 회전전극 표면 세정을 위한 지르코니아 세라믹 비즈',
    shortDescriptionEn: 'Zirconia ceramic cleaning beads for the WBCL10 rotating electrode',
    description: 'WBCL10 잔류염소계의 필터 하우징 내부에서 회전전극 표면의 이물질 부착을 줄이는 세정용 소모품입니다.',
    descriptionEn: 'A cleaning consumable used inside the WBCL10 filter housing to help limit deposits on the rotating-electrode surface.',
    features: ['WBCL10 전용', '이트리아 안정화 지르코니아', '직경 1.0-1.2 mm 구형 비즈'],
    featuresEn: ['For WBCL10', 'Yttria-stabilized zirconia', '1.0-1.2 mm spherical beads'],
    specs: [
      { label: '호환 기종', labelEn: 'Compatible Model', value: 'WBCL10', valueEn: 'WBCL10' },
