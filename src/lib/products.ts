...
Its graphite disc sensing element, K=1 cell constant and PT1000 temperature compensation support a range from 1 μS/cm to 20 mS/cm.`,
  ...
  },
  {
    slug: 'ph-ec-board',
    model: 'WB-PES',
    name: 'pH·EC 센서 인터페이스 보드',
    nameEn: 'pH & EC Sensor Interface Board',
    category: '스마트팜 인터페이스',
    categoryEn: 'Smart Farm Interface',
    group: 'smartfarm',
    application: ['smart_farm'],
    featured: false,
    shortDescription: '스마트팜 제어반에 pH·EC 센서 신호를 연결하는 내장형 인터페이스 보드',
    shortDescriptionEn: 'Embedded interface board connecting pH and EC sensor signals to smart-farm control panels',
    description: `WB-PES는 스마트팜의 pH·EC 센서를 현장 제어반과 연결하기 위한 센서 인터페이스 보드입니다.
센서 입력과 온도 보정 신호를 받아 제어 시스템에서 사용할 수 있도록 구성하며, 펌프 및 양액 제어반 내부에 설치할 수 있습니다.`,
    descriptionEn: `The WB-PES connects pH and EC sensors with smart-farm control panels.
It receives sensor and temperature-compensation signals for use by the control system and can be installed inside pump or nutrient-solution control panels.`,
    features: [
      'pH·EC 센서 입력 인터페이스',
      'PT1000 온도 보정 신호 연동',
      '제어반 내장형 보드 구조',
    ...
    featuresEn: [
      'pH and EC sensor input interface',
      'PT1000 temperature-compensation input',
      'Embedded control-panel board format',
      'Pump and nutrient-control system integration',
      'Communication and outputs configured for the site',
    ],
    specs: [
      { label: '센서 입력', labelEn: 'Sensor Inputs', value: 'pH / EC', valueEn: 'pH / EC' },
      { label: '온도 입력', labelEn: 'Temperature Input', value: 'PT1000', valueEn: 'PT1000' },
      { label: '설치 방식', labelEn: 'Installation', value: '제어반 내장형', valueEn: 'Embedded in control panel' },
      { label: '연동 구성', labelEn: 'Integration', value: '펌프·양액 제어 시스템', valueEn: 'Pump and nutrient-control systems' },
      { label: '통신 및 출력', labelEn: 'Communication & Output', value: '현장 구성 사양', valueEn: 'Site-configured' },
    ],
    image: '/images/products/wb-pes-main.png',
    gallery: ['/images/products/wb-pes-main.png'],
  },
  {
    slug: 'filter-drain',
    model: 'WB-FD',
...
Its transparent acrylic body allows visual inspection and can be configured to match site piping and instrumentation.`,
  ...
  },
  {
    ...
    image: '/images/products/wbtu10-lamp-kit.png',
    gallery: ['/images/products/wbtu10-lamp-kit.png'],
    price: '가격 문의',
    priceEn: 'Contact for price',
    purchasable: true,
