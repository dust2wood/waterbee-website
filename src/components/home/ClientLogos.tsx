...
const clients = {
  ko: [
    ...
    { name: '지방 환경청',     category: '산업·하폐수' },
    { name: '산업단지 공단',   category: '산업·하폐수' },
    { name: '지자체 하수처리장', category: '산업·하폐수' },
    { name: '식품·제약 업체', category: '산업·하폐수' },
  ],
  en: [
    { name: 'Metro Waterworks',       category: 'Water Treatment' },
    { name: 'K-Water',                category: 'Water Treatment' },
    { name: 'Regional EPA Offices',   category: 'Industrial' },
    { name: 'Industrial Complexes',   category: 'Industrial' },
    { name: 'Municipal WWTP',         category: 'Wastewater' },
    { name: 'Food & Pharma',          category: 'Industrial' },
  ],
}
...
export default function ClientLogos() {
  ...
  const clientList = isKo ? clients.ko : clients.en
  const statList   = isKo ? stats.ko   : stats.en
